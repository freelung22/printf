...
/**
 * percent_hand - Controller for percent format
 * @str: String format
 * @list: List of arguments
 * @i: Iterator
 *
 ...
 **/
int percent_hand(const char *str, va_list list, int *i)
{
	...
	format formats[] = {
		...
		{'o', print_oct}, {'x', print_hexadec_low},
		{'X', print_hexadec_upp}, {'p', print_point},
